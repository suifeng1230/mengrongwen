...
function Swipe(container, touch_target, options) {
    ...
    var events = {
        ...
        start: function(event) {
            ...
            touch_dom.addEventListener('touchmove', this, false);
            touch_dom.addEventListener('touchend', this, false);
    ...
    if (browser.addEventListener) {
        ...
        if (browser.touch) touch_dom.addEventListener('touchstart', events, false);

        if (browser.transitions) {
            touch_dom.addEventListener('webkitTransitionEnd', events, false);
            touch_dom.addEventListener('msTransitionEnd', events, false);
            touch_dom.addEventListener('oTransitionEnd', events, false);
            touch_dom.addEventListener('otransitionend', events, false);
            touch_dom.addEventListener('transitionend', events, false);
        }
    ...
    return {
        ...
        kill: function() {
            ...
            if (browser.addEventListener) {
                ...
                touch_dom.removeEventListener('touchstart', events, false);
                touch_dom.removeEventListener('webkitTransitionEnd', events, false);
                touch_dom.removeEventListener('msTransitionEnd', events, false);
                touch_dom.removeEventListener('oTransitionEnd', events, false);
                touch_dom.removeEventListener('otransitionend', events, false);
                touch_dom.removeEventListener('transitionend', events, false);
