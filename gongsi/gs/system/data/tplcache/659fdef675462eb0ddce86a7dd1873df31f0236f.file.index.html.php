		...
		<ul class="ten_tieshi">
			<li class="lt">
				...
				<div class="lt tieshi_text">
					...
					<p>在家自装装修网发布装修招标只需要1分钟，让您能够花最短的时间找到最适合的装修公司，家自装为您 提供的都是经过严格资格认证的正规装修公司，保证后期施工质量以及资金安全，业主可以放心选择。</p>
				</div>
			</li>
			<li class="rt">
				...
				<div class="lt tieshi_text">
					...
					<p>己在市面上找装修公司，您可能需要东奔西跑进行选择比较，费时费力，家自装针对您的需求为您提供装修公司，免费量房，免费出设计方案和报价，让您可以足不出户就能找到心仪的公司。不需要您支付任何费用。</p>
				</div>
			</li>
			<li class="lt">
