<?php /* Smarty version Smarty-3.1.8, created on 2018-04-08 15:53:25
		...
		<div class="index_study">
			...
			<div class="index_news_list rt">
				<ul>
					...
					<li>
						<a href="<{$item.link}>" class="lt"><img src="<{$pager.img}>/<{$item.thumb}>" alt="<{$item.title}>"/></a>
						<div class="index_news_list_text rt">
							<h3><a class="tit" href="<{$item.link}>"><{$item.title|cutstr:27}></a></h3>
							<a href="<{$item.link}>"><{$item.desc|cutstr:100}><font class="fontcl2">[详情]</font></a>
						</div>
						<div class="cl"></div>
					</li>
