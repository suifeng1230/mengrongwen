...
class __CFG
{
    ...
    CONST RES_URL = 'http://www.gongsi.com/static';

    CONST MYSQL = 'mysql://root:root@localhost:3306/gongsi/jh_/UTF8';

    CONST SECRET_KEY = '45b118d956c8ad73a8c05691e05b9a51';
    CONST Authorize = '';
    ...
    CONST CACHE_FILE_SIZE = '52M'; //开辟缓存文件大小
