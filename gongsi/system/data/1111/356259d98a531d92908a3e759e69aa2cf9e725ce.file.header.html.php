<?php /* Smarty version Smarty-3.1.8, created on 2018-04-08 11:49:15
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\shop\block\header.html" */ ?>
<?php /*%%SmartyHeaderCode:48685ac9913b329ff4-14114802%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '356259d98a531d92908a3e759e69aa2cf9e725ce' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\shop\\block\\header.html',
      1 => 1506593777,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '48685ac9913b329ff4-14114802',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac9913b5857d3_35683824',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac9913b5857d3_35683824')) {function content_5ac9913b5857d3_35683824($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
if (!is_callable('smarty_modifier_shoprank')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\modifier.shoprank.php';
if (!is_callable('smarty_modifier_qq')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\modifier.qq.php';
...
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='index'){?>class="current"<?php }?>>商铺首页</a></li>
			<?php if ($_smarty_tpl->tpl_vars['shop']->value['domain']==''){?>
...
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='comment'){?>class="current"<?php }?>>口碑点评</a></li>
			...
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['shop']->value['domain']){?>
			<li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:shop/info','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='info'){?>class="current"<?php }?>>商家介绍</a></li>
			<li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:shop/product','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='product'){?>class="current"<?php }?>>所有产品</a></li>
			<li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:shop/coupon','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='coupon'){?>class="current"<?php }?>>优惠券</a></li>
			<li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:shop/news','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='news'){?>class="current"<?php }?>>活动资讯</a></li>
			<?php if ($_smarty_tpl->tpl_vars['shop']->value['group']['priv']['allow_mendian']>-1){?><li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:mendian','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='mendian'){?>class="current"<?php }?>>门店展示</a></li><?php }?>
			<li><a href="<?php echo smarty_function_link(array('ctl'=>'mall/shop:shop/comment','arg0'=>$_smarty_tpl->tpl_vars['shop']->value['shop_id'],'shop'=>$_smarty_tpl->tpl_vars['shop']->value),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['request']->value['act']=='comment'){?>class="current"<?php }?>>口碑点评</a></li>
			<li></li>
			<?php }?>	
		</ul>
