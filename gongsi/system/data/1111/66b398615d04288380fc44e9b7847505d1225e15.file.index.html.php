<?php /* Smarty version Smarty-3.1.8, created on 2018-04-09 14:17:10
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\index.html" */ ?>
<?php /*%%SmartyHeaderCode:112735ac42bc5916a33-99356956%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '66b398615d04288380fc44e9b7847505d1225e15' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\index.html',
      1 => 1523254627,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '112735ac42bc5916a33-99356956',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5ac42bc5adbca7_45428326',
  'variables' => 
  array (
    'request' => 0,
    'pager' => 0,
...
<?php if ($_valid && !is_callable('content_5ac42bc5adbca7_45428326')) {function content_5ac42bc5adbca7_45428326($_smarty_tpl) {?><?php if (!is_callable('smarty_function_adv')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.adv.php';
...
<div class="mainwd">
	...
	.baokuan{background: url(/themes/default/static/images/baokuan.png) no-repeat;height: 676px; width: 1280px; float: left; margin-left: -344px; margin-top: 15px;}
...
" class="rt more"  target="_blank">更多</a></h2>
			<ul class="block_type area">
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('calldata', array('mdl'=>"tenders/tenders",'sign_company_id'=>">:0",'city_id'=>$_smarty_tpl->tpl_vars['request']->value['city_id'],'limit'=>"4")); $_block_repeat=true; echo smarty_block_calldata(array('mdl'=>"tenders/tenders",'sign_company_id'=>">:0",'city_id'=>$_smarty_tpl->tpl_vars['request']->value['city_id'],'limit'=>"4"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
				...
				<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_calldata(array('mdl'=>"tenders/tenders",'sign_company_id'=>">:0",'city_id'=>$_smarty_tpl->tpl_vars['request']->value['city_id'],'limit'=>"4"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
