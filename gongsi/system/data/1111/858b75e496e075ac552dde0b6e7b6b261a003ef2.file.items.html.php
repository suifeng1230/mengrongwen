<?php /* Smarty version Smarty-3.1.8, created on 2018-04-09 14:02:42
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\gs\items.html" */ ?>
<?php /*%%SmartyHeaderCode:139215ac42c14718ea9-96576115%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '858b75e496e075ac552dde0b6e7b6b261a003ef2' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\gs\\items.html',
      1 => 1498806460,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139215ac42c14718ea9-96576115',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5ac42c149207a6_72350254',
  'variables' => 
  array (
    'CONFIG' => 0,
    'area_all_link' => 0,
...
<?php if ($_valid && !is_callable('content_5ac42c149207a6_72350254')) {function content_5ac42c149207a6_72350254($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
...
</a> ><a href="<?php echo smarty_function_link(array('ctl'=>'gs:items'),$_smarty_tpl);?>
">找装修公司</a> </p>
	</div>
</div>
<!--面包屑导航结束-->
	...
	<div class="main_content lt">
		<div class="mb10 pding area choose_option">
			<table>
				<tr>
					<td class="tit">区域：</td>
					<td> <a href="<?php echo $_smarty_tpl->tpl_vars['area_all_link']->value;?>
" <?php if (empty($_smarty_tpl->tpl_vars['pager']->value['area_id'])){?>class="current"<?php }?>>不限</a> <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['area_id']==$_smarty_tpl->tpl_vars['pager']->value['area_id']){?>class="current"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['area_name'];?>
				...
				<tr>
					<td class="tit">等级：</td>
					<td> <a href="<?php echo $_smarty_tpl->tpl_vars['group_all_link']->value;?>
" <?php if (empty($_smarty_tpl->tpl_vars['pager']->value['group_id'])){?>class="current"<?php }?>>不限</a> <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
" <?php if ($_smarty_tpl->tpl_vars['v']->value['checked']){?>class="current"<?php }?>>不限</a> <?php  $_smarty_tpl->tpl_vars['vv'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vv']->_loop = false;
...
"  <?php if ($_smarty_tpl->tpl_vars['vv']->value['checked']){?>class="current"<?php }?>><?php echo $_smarty_tpl->tpl_vars['vv']->value['title'];?>
		...
		<div class="mb20">
			<h2>装修公司列表</h2>
			<div class="sort_box">
				<p class="sort_list hoverno"> <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
<span <?php if ($_smarty_tpl->tpl_vars['k']->value==$_smarty_tpl->tpl_vars['pager']->value['order']){?>class="sort_ico ico_list sort_on_ico"<?php }else{ ?>class="sort_ico ico_list"<?php }?>></span></a> <?php } ?> </p>
			</div>
			<div class="area">
				<ul class="block_type">
...
?>
					<li>
						<div class="main_company main_list"> <a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['company_url'];?>
...
" /><?php if ($_smarty_tpl->tpl_vars['item']->value['is_vip']){?><span class="qijian_ico ico_list"></span><?php }?></a>
							<div class="main_com_rt main_list_rt rt">
								<h3>
									<p class="lt"><b><a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['company_url'];?>
...
元<font class="ico_list"></font></span><?php }?></p>
									<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $_smarty_tpl->tpl_vars['item']->value['show_qq'];?>
&site=qq&menu=yes" class="ico_list qq_ico rt"></a></h3>
								...
								<div class="rt pingfen_bar"> <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
...
%"></span></span><?php echo sprintf("%.2f",$_smarty_tpl->tpl_vars['item']->value['avg_scores'][$_smarty_tpl->tpl_vars['k']->value]);?>
									...
									<?php } ?>
									<?php if ($_smarty_tpl->tpl_vars['item']->value['group']['priv']['allow_yuyue']==1){?> <a href="<?php echo smarty_function_link(array('ctl'=>'gs:yuyue','arg0'=>$_smarty_tpl->tpl_vars['item']->value['company_id'],'http'=>'ajax'),$_smarty_tpl);?>
" mini-width='500' mini-load="免费预约" class="btn_main_big btn rt">免费预约</a> <?php }else{ ?> <a href="<?php echo smarty_function_link(array('ctl'=>'tenders:fast','arg0'=>$_smarty_tpl->tpl_vars['item']->value['uid'],'http'=>'ajax'),$_smarty_tpl);?>
" mini-width='500' mini-load="立即招标" class="btn_main_big btn rt">立即招标</a> <?php }?> </div>
							</div>
							<div class="cl"></div>
						</div>
					</li>
				...
				<div class="page hoverno"><?php echo $_smarty_tpl->tpl_vars['pager']->value['pagebar'];?>
</div>
				<?php }?> </div>
		</div>
	</div>
	<!--主体左边内容结束--> 
	<!--主体右边内容开始-->
	<div class="side_content rt"> <?php echo smarty_function_widget(array('id'=>"tenders/fast",'title'=>"免费装修设计",'from'=>"TSJ"),$_smarty_tpl);?>
