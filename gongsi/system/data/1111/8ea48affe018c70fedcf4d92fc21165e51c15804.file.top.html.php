<?php /* Smarty version Smarty-3.1.8, created on 2018-04-08 16:31:52
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\index\top.html" */ ?>
<?php /*%%SmartyHeaderCode:117905ac42bc5b0e934-03295388%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ea48affe018c70fedcf4d92fc21165e51c15804' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\index\\top.html',
      1 => 1523176308,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '117905ac42bc5b0e934-03295388',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5ac42bc5bba758_63903427',
  'variables' => 
  array (
    'COUNT' => 0,
    'CONFIG' => 0,
...
<?php if ($_valid && !is_callable('content_5ac42bc5bba758_63903427')) {function content_5ac42bc5bba758_63903427($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
        ...
        <div class="index_menu_con">
            <div class="index_menu_list" lay="tenders-form1">
                <div class="pding menu_list_top">
                    <p class="tp"><i class="tit lt"><span class="index_ico head_sq_ico"></span>免费装修保</i><span class="rt">目前已帮助<b class="fontcl1"><?php echo $_smarty_tpl->tpl_vars['COUNT']->value['tenders'];?>
</b>位业主</span></p>
...
向您的朋友圈进行口碑宣传，我们将对此向您表示感谢！</p>
            ...
            <div class="index_menu_list none" lay="tenders-form5">
                <div class="pding menu_list_top">
                    <p class="tp"><i class="tit lt"><span class="index_ico head_sq_ico"></span>免费申请装修保</i><span class="rt">目前已帮助<b class="fontcl1"><?php echo $_smarty_tpl->tpl_vars['COUNT']->value['tenders'];?>
</b>位业主</span></p>
                    <form action="<?php echo smarty_function_link(array('ctl'=>'tenders:save','http'=>'base'),$_smarty_tpl);?>
...
$("[mini-tenders]").click(function(){
	...
	if(mj){
		...
		var link = "<?php echo smarty_function_link(array('ctl'=>'index:get_price','arg0'=>'#mj'),$_smarty_tpl);?>
";
