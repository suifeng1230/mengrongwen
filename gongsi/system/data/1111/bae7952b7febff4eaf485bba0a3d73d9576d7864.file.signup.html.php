<?php /* Smarty version Smarty-3.1.8, created on 2018-04-04 10:15:53
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\passport\signup.html" */ ?>
<?php /*%%SmartyHeaderCode:237715ac43559c57f22-27107406%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bae7952b7febff4eaf485bba0a3d73d9576d7864' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\passport\\signup.html',
      1 => 1503309105,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '237715ac43559c57f22-27107406',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac43559d51f62_01725227',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac43559d51f62_01725227')) {function content_5ac43559d51f62_01725227($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
...
">返回重新选择</a></p>
			<?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['connect']['qq_is_open']&&$_smarty_tpl->tpl_vars['CONFIG']->value['connect']['qq_is_open']&&$_smarty_tpl->tpl_vars['CONFIG']->value['connect']['weibo_is_open']){?><h3>第三方账号登录：</h3><?php }else{ ?><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['connect']['qq_is_open']){?><a href="<?php echo smarty_function_link(array('ctl'=>'passport:qqlogin'),$_smarty_tpl);?>
" class="login_qq hl_icon" title="QQ登录"></a><?php }else{ ?><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['connect']['weibo_is_open']){?><a href="<?php echo smarty_function_link(array('ctl'=>'passport:weibo'),$_smarty_tpl);?>
" class="login_weibo hl_icon" title="微博登录"></a><?php }else{ ?><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['CONFIG']->value['connect']['weixin_is_open']){?><a href="<?php echo smarty_function_link(array('ctl'=>'passport:weixin','http'=>'ajax'),$_smarty_tpl);?>
" mini-width="350" mini-load="请使用微信扫描二维码登录" class="login_weixin hl_icon"  title="微信登录"></a><?php }else{ ?><?php }?>
