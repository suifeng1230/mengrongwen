<?php /* Smarty version Smarty-3.1.8, created on 2018-04-08 15:57:12
         compiled from "D:\phpStudy\WWW\gongsi\themes\default\site\items.html" */ ?>
<?php /*%%SmartyHeaderCode:158185ac9cb58a02af2-33715996%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7583c04cfa6273d96aa5bb9fc763af6beb9cf1a' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\gongsi\\themes\\default\\site\\items.html',
      1 => 1496371991,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '158185ac9cb58a02af2-33715996',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac9cb58c6bd37_19979068',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac9cb58c6bd37_19979068')) {function content_5ac9cb58c6bd37_19979068($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'D:\\phpStudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
		...
		<div class="mb10 pding area choose_option">
			<table>
				<tr>
					<td class="tit">区域：</td>
					<td>
                        <a  href="<?php echo smarty_function_link(array('ctl'=>'site:items','arg0'=>0,'arg1'=>$_smarty_tpl->tpl_vars['pager']->value['status'],'arg2'=>$_smarty_tpl->tpl_vars['pager']->value['order'],'arg3'=>1),$_smarty_tpl);?>
...
?>
                        <a href="<?php echo smarty_function_link(array('ctl'=>'site:items','arg0'=>$_smarty_tpl->tpl_vars['v']->value['area_id'],'arg1'=>$_smarty_tpl->tpl_vars['pager']->value['status'],'arg2'=>$_smarty_tpl->tpl_vars['pager']->value['order'],'arg3'=>1),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['v']->value['area_id']==$_smarty_tpl->tpl_vars['pager']->value['area_id']){?>class="current"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['area_name'];?>
            ...
            <table>
				<tr>
					<td class="tit">状态：</td>
					<td>
                        <a  href="<?php echo smarty_function_link(array('ctl'=>'site:items','arg0'=>$_smarty_tpl->tpl_vars['pager']->value['area_id'],'arg1'=>0,'arg2'=>$_smarty_tpl->tpl_vars['pager']->value['order'],'arg3'=>1),$_smarty_tpl);?>
" <?php if (empty($_smarty_tpl->tpl_vars['pager']->value['status'])){?>class="current"<?php }?>>不限</a>
                        <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
?>
                        <a href="<?php echo smarty_function_link(array('ctl'=>'site:items','arg0'=>$_smarty_tpl->tpl_vars['pager']->value['area_id'],'arg1'=>$_smarty_tpl->tpl_vars['k']->value,'arg2'=>$_smarty_tpl->tpl_vars['pager']->value['order'],'arg3'=>1),$_smarty_tpl);?>
" <?php if ($_smarty_tpl->tpl_vars['k']->value==$_smarty_tpl->tpl_vars['pager']->value['status']){?>class="current"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
</a>
                        <?php } ?>
					</td>
				</tr>
...
"  target="_blank"><font class="fontcl2"> <?php echo $_smarty_tpl->tpl_vars['company_list']->value[$_smarty_tpl->tpl_vars['item']->value['company_id']]['name'];?>
                                                ...
                                                <?php }elseif($_smarty_tpl->tpl_vars['gz_list']->value){?>
                                                	承接工长：<a href="<?php echo smarty_function_link(array('ctl'=>'gz:detail','arg0'=>$_smarty_tpl->tpl_vars['item']->value['uid']),$_smarty_tpl);?>
"  target="_blank"><font class="fontcl2"> <?php echo $_smarty_tpl->tpl_vars['gz_list']->value[$_smarty_tpl->tpl_vars['item']->value['uid']]['name'];?>
 </font></a>
