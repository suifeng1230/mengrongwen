<?php /* Smarty version Smarty-3.1.8, created on 2018-04-17 10:20:59
         compiled from "admin:product/product/items.html" */ ?>
<?php /*%%SmartyHeaderCode:3015ad55a0bededf5-88470436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3015ad55a0bededf5-88470436',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ad55a0c3e26f1_71165288',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ad55a0c3e26f1_71165288')) {function content_5ad55a0c3e26f1_71165288($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include 'E:\\phpstudy\\WWW\\gongsi\\system\\plugins/smarty\\function.link.php';
...
/images/main-h5-ico.gif" alt="" /></td>
			...
			<td align="right">
			<?php echo smarty_function_link(array('ctl'=>"product/product:so",'load'=>"mini:搜索商品",'width'=>"mini:500",'class'=>"button",'title'=>"搜索"),$_smarty_tpl);?>
 &nbsp; &nbsp;
			<?php echo smarty_function_link(array('ctl'=>"product/product:create",'class'=>"button",'title'=>"添加"),$_smarty_tpl);?>
</td>
			<td width="15"></td>
		</tr>
	</table>
...
<div class="page-data">	
    ...
    <table width="100%" border="0" cellspacing="0" class="table-data table">
        <tr>
            <th class="w-100">ID</th><th>标题</th><th>店铺</th><th>城市</th><th class="w-50">分类</th><th>品牌</th>
...
<label></td>
            ...
            <td><a href="?product/product-shop-<?php echo $_smarty_tpl->tpl_vars['item']->value['shop_id'];?>
.html"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['shop_list']->value[$_smarty_tpl->tpl_vars['item']->value['shop_id']]['title'])===null||$tmp==='' ? '--' : $tmp);?>
...
)</td><td><?php echo $_smarty_tpl->tpl_vars['item']->value['cate_title'];?>
