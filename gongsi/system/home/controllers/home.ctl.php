...
class Ctl_Home extends Ctl
{
    ...
    public function items()
    {
        ...
        // $area_all_link 当前网址后接 $attr_value_ids 
        ...
        $pager['count'] = $count = 0;
        $filter['city_id'] = $this->request['city_id'];  //当前城市id
        if($area_id){
    ...
    {
        $home = $this->check_home($home_id); //当前id的所有内容 
        K::M('home/home')->update_count($home_id, 'views', 1); //K::M()未知意思   
